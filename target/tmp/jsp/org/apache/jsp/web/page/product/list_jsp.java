 ...
 * Generated at: 2019-07-18 03:17:14 UTC
...
return;
    ...
    String path = app + "/common";
      ...
      out.write("    <h2 class=\"layui-colla-title\">商品信息-查询条件</h2>\r\n");
      ...
      out.write("\t\t<legend>商品信息-查询条件</legend>\r\n");
      ...
      out.write("\t\t\t<thead>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th>序号</th><th>商品类型</th><th>商品编号</th><th>商品名称</th><th>商品价格</th>\r\n");
      out.write("\t\t\t\t\t<th>商品数量</th><th>商品状态</th><th>操作</th>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</thead>\r\n");
      out.write("\t\t\t<tbody id=\"product_tbody\"></tbody>\r\n");
      out.write("\t\t</table>\r\n");
      ...
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl :'/store/product/list.do',\r\n");
      ...
      out.write("        var describe=dom.describe?dom.describe:'';\r\n");
      out.write("        var number=dom.number?dom.number:'';\r\n");
      out.write("        var d={i:(i+1),categoryCode:categoryCode,code:code,name:name,\r\n");
      out.write("        \t\tprice:price,state:state,describe:describe,\r\n");
      ...
      out.write("\topenLayer('/store/web/page/product/add.jsp',refresh)\r\n");
      out.write("}\r\n");
      out.write("function openUpd(code){\r\n");
      out.write("\topenLayer('/store/web/page/product/upd.jsp?code='+code,refresh)\r\n");
      out.write("}\r\n");
      out.write("function image(code){\r\n");
      out.write("\topenLayer('/store/web/page/image/list.jsp?code='+code,refresh)\r\n");
      out.write("}\r\n");
      out.write(" function del(code){\r\n");
      out.write("\topenConfirm(function(index){\r\n");
      out.write("\t\tajax('/store/product/delete.do', {code:code}, 'text', function(data){\r\n");
      out.write("\t\t\t if (data==0) {\r\n");
      ...
      out.write("<tr>\r\n");
      out.write("<td>{{ d.i }}</td><td>{{ d.categoryCode }}</td><td>{{ d.code }}</td><td>{{ d.name }}</td><td>{{ d.price }}</td>\r\n");
      out.write("<td>{{ d.number }}</td><td>{{ d.state }}</td>\r\n");
      out.write("<td>\r\n");
      out.write("<input type='button' value='图片管理' class='layui-btn' \r\n");
      out.write("           onclick='image(\"{{ d.code }}\")'/>&nbsp;\r\n");
