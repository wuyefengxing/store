 ...
 * Generated at: 2019-07-18 03:17:11 UTC
...
return;
    ...
    String path = app + "/common";
      ...
      out.write("\r\n");
      out.write("\t<title>订单信息维护</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<div class=\"layui-collapse\">\r\n");
      out.write("  <div class=\"layui-colla-item\">\r\n");
      out.write("    <h2 class=\"layui-colla-title\">订单信息-查询条件</h2>\r\n");
      ...
      out.write("\t\t<legend>订单信息-查询条件</legend>\r\n");
      out.write("\t\t<form class=\"layui-form\">\r\n");
      out.write("\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t<label class=\"layui-form-label\">订单编号</label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"code\" placeholder=\"请输入订单编号\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("             <label class=\"layui-form-label\">用户编号</label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"userCode\" placeholder=\"请输入用户编号\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t<thead>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th>序号</th><th>订单编号</th><th>时间</th>\r\n");
      out.write("\t\t\t\t\t<th>地址</th><th>商品状态</th><th>用户名</th><th>操作</th>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</thead>\r\n");
      out.write("\t\t\t<tbody id=\"product_order\"></tbody>\r\n");
      out.write("\t\t</table>\r\n");
      ...
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl :'/store/order/listAll.do',\r\n");
      ...
      out.write("\t\t        var userName=dom.name?dom.name:'';\r\n");
      out.write("\t\t        var d={i:(i+1),code:code,userCode:userCode,time:time,\r\n");
      out.write("\t\t        \t\tstate:state,address:address,userName:userName};\r\n");
      out.write("\t\t        html += getlaytpl('#tradd',d);\r\n");
      out.write("\t\t    });\r\n");
      out.write("\t\t    $(\"#product_order\").html(html);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("})\r\n");
      ...
      out.write("\topenLayer('/store/web/page/order/add.jsp',refresh)\r\n");
      out.write("}\r\n");
      out.write("function product(code){\r\n");
      out.write("\topenLayer('/store/web/page/order/orderProduct.jsp?code='+code,refresh)\r\n");
      out.write("}\r\n");
      out.write(" function del(code){\r\n");
      out.write("\topenConfirm(function(index){\r\n");
      out.write("\t\tajax('/store/order/delete.do', {code:code}, 'text', function(data){\r\n");
      ...
      out.write("<tr>\r\n");
      out.write("<td>{{ d.i }}</td><td>{{ d.code }}</td><td>{{ d.time }}</td><td>{{ d.address }}</td>\r\n");
      out.write("<td>{{ d.state }}</td><td>{{ d.userName }}</td>\r\n");
      out.write("<td>\r\n");
      out.write("    <input type='button' value='订单商品查看' class='layui-btn' \r\n");
      out.write("           onclick='product(\"{{ d.code }}\")'/>&nbsp;\r\n");
